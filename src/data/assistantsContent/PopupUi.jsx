    ...
    const handleSubmit = async (event) => {
        ...
        event.preventDefault();
            ...
            try {
                ...
                await updateData();
                toast.success("Successfully added new Assistant");
            } catch(err) {
                console.log('Error in adding new assistant', err);
            }
    }
                    ...
                    <Form.Group className="d-flex flex-row row-centeritems">
                        ...
                        <div className="my-0 py-0 col-8">
                            {countryList.length > 0 ? (
                                <Form.Select id="addassistant-select-country" className="notif-formselect" aria-label="Select Country" onChange={(e) => settingCountry(e)}>
                                ...
                                <Form.Select disabled id="addassistant-select-country" className="notif-formselect" aria-label="Select Country">
                                    <option>Select Country</option>
                                </Form.Select>
                            )}
                        </div>
            ...
            <div className="row">
                <div className="col">
                    <div className="d-flex flex-row justify-content-center column-gap-5 ">
                        <Button id="addassistant-submitbutton" disabled={!validateForm()} className="custom-btn" type="submit">
                            Submit
                        </Button>
                        <Button id="addassistant-cancelbutton" className="custom-btn-cancel" onClick={onCancel}>
                            Cancel
                        </Button>
                    </div>
                </div>
